...
<div class="containerlegende">
	<div class="legende">
		<div class="colonneLegende">
			Niveau 1 : Nuit Nuageuse (0.1 lux)<br>
			Niveau 2 : Pleine lune (0.5 lux)<br>
			Niveau 3 : Crépuscule (1 lux)<br>
			Niveau 4 : Eclairage public (20 lux)<br>
			Niveau 5 : Jour très couvert (100 lux)
		</div>
		<div class="colonneLegende">
			Niveau 6 : Éclairage de bureau (500 lux)<br>
			Niveau 7 : Jour couvert (1 000 lux)<br>
			Niveau 8 : Jour typique (10 000 lux)<br>
			Niveau 9 : Eté ensoleillée (50 000 lux)<br>
			Niveau 10 : Ensoleillement direct (100 000 lux)
		</div>
	</div>
</div>
